<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\WWW\weixinss\weixin\public/../application/home\view\hets\index.html";i:1492602613;}*/ ?>
<html>
<head>
...
<link rel="shortcut icon" type="image/x-icon" href="../../../../public/log.ico">
<script nonce="" type="text/javascript">
...
<title>馒头商学院</title>
<link rel="stylesheet" href="../../../../public/css/het/index.css">
...
<div class="container">
	...
	<!-- 轮播图-2698 -->   
    <div class="swiper" style="height: 180px; width: 4047px; transform: translate3d(0px, 0px, 0px); transition: 300ms;" style="display: block;">
		
		<div class="item js_post" style="width: 1349px; height: 180px;">
			<a href="http://mp.weixin.qq.com/s?__biz=MzA3MDk4NzMzNg==&amp;mid=2651703693&amp;idx=1&amp;sn=6663c8ddb974383a3a6a5dae5b70c70a&amp;scene=19#wechat_redirect">
				<div class="img js_img" style="background-image: url('../../../../public/uploads/20170418/8585a274bca3fc0821605eff773fe41e.jpg');width: 20%;"></div>
				<p class="desc js_title">网易云音乐产品负责人亲述：云音乐各产品发展阶段的实战经验</p>
			</a>
		</div>
		
		<div class="item js_post" style="width: 1349px; height: 180px;">
			<a href="http://mp.weixin.qq.com/s?__biz=MzA3MDk4NzMzNg==&amp;mid=2651705389&amp;idx=1&amp;sn=25a4a02046aba2ccdddcd0638604e380&amp;scene=19#wechat_redirect">
				<div class="img js_img" style="background-image: url('../../../../public/uploads/20170418/8585a274bca3fc0821605eff773fe41e.jpg');width: 20%;"></div>
				<p class="desc js_title">牛逼的文案人会写标题，借热点，当然，还有一个不为人知的技能...</p>
			</a>
		</div>
		
		<div class="item js_post" style="width: 1349px; height: 180px;">
			<a href="http://mp.weixin.qq.com/s?__biz=MzA3MDk4NzMzNg==&amp;mid=2651705402&amp;idx=1&amp;sn=7e15eb4d3a8184738c9ab7a4640200e1&amp;scene=19#wechat_redirect">
				<div class="img js_img" style="background-image: url('../../../../public/uploads/20170418/8585a274bca3fc0821605eff773fe41e.jpg');width: 20%;"></div>
				<p class="desc js_title">打杂运营变身高级运营，哪些技能是不可或缺的？</p>
			</a>
		</div>
...
<div class="tab js_plugin" id="namespace_1" data-pid="2">
	<div class="tab_hd">
		<div class="tab_hd_inner">
			...
			<div type="index" data-index="0" class="item active">产品经理</div>
			
			<div type="index" data-index="1" class="item ">营销干货</div>
			
			<div type="index" data-index="2" class="item ">运营进阶</div>
	...
	<div class="tab_bd">
		...
		<!-- 热文展示 -->
		<?php foreach($arr['pro'] as $k1 => $v1) : ?>
			<a class="list_item js_post" href="__URL__/details?hid=<?=  $v1['h_id'] ?>">
				<div class="cover">
					<img class="img js_img" src="../../../../public/<?= $v1['h_img']  ?>" alt="">
				</div>
				<div class="cont">
					<h2 class="title js_title"><?= $v1['h_title']  ?></h2>
					<p class="desc"><?= $v1['h_content']  ?></p>
				</div>
			</a>
		<?php endforeach  ?>
		...
		<?php foreach($arr['mark'] as $k2 => $v2) : ?>
			<a class="list_item js_post" href="__URL__/details?hid=<?=  $v2['h_id'] ?>">
				<div class="cover">
					<img class="img js_img" src="../../../../public/<?= $v2['h_img']  ?>" alt="">
				</div>
				<div class="cont">
					<h2 class="title js_title"><?= $v2['h_title']  ?></h2>
					<p class="desc"><?= $v2['h_content']  ?></p>
				</div>
			</a>
		<?php endforeach  ?>
		...
		<?php foreach($arr['ope'] as $k3 => $v3) : ?>
			<a class="list_item js_post" href="__URL__/details?hid=<?=  $v3['h_id'] ?>">
				<div class="cover">
					<img class="img js_img" src="../../../../public/<?= $v3['h_img']  ?>" alt="">
				</div>
				<div class="cont">
					<h2 class="title js_title"><?= $v3['h_title']  ?></h2>
					<p class="desc"><?= $v3['h_content']  ?></p>
				</div>
			</a>
		<?php endforeach  ?>
...
(function() {
	...
	if (
        ...
        <script>window.moon_map = {"biz_common/utils/report.js":"//res.wx.qq.com/mmbizwap/zh_CN/htmledition/js/biz_common/utils/report3518c6.js","homepage/report.js":"//res.wx.qq.com/mmbizwap/zh_CN/htmledition/js/homepage/report243273.js","biz_wap/zepto/event.js":"//res.wx.qq.com/mmbizwap/zh_CN/htmledition/js/biz_wap/zepto/event34c264.js","biz_wap/zepto/ajax.js":"//res.wx.qq.com/mmbizwap/zh_CN/htmledition/js/biz_wap/zepto/ajax34c264.js","biz_wap/zepto/zepto.js":"//res.wx.qq.com/mmbizwap/zh_CN/htmledition/js/biz_wap/zepto/zepto34c264.js","homepage/index.js":"//res.wx.qq.com/mmbizwap/zh_CN/htmledition/js/homepage/index2e7b74.js"};</script>
<script>
var cgiData = {
	biz: 'MzA3MDk4NzMzNg==',
	hid: '1',
...
<script type="text/javascript" src="../../../../public/js/het/soon.js"></script>
<script>
