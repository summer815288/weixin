<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/data/wwwroot/default/weixin/public/../application/home/view/personal/course.html";i:1492766437;s:79:"/data/wwwroot/default/weixin/public/../application/home/view/index/footer5.html";i:1492765789;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
<center>
    <div class="headers">正在学习</div>
    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    <a href="<?php echo url('index/detail'); ?>?id=<?php echo $vo['id']; ?>" class="detail" id="<?php echo $vo['id']; ?>" style=" text-decoration: none;color:black;">
