<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\weixin\weixin\public/../application/home\view\login\login.html";i:1492602735;}*/ ?>
<?php
use think\Url;
?>
<html lang="en">
        ...
        <div class="weui-cells__title">
            ...
            <div class="weui-cell">
                <div class="weui-cell__bd">
                    <input type="text" class="weui-input"  placeholder="请输入账号" name="account" style="font-size: 40px;"><br>
                </div>
            </div>
