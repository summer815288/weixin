<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/data/wwwroot/default/weixin/public/../application/home/view/league/payment.html";i:1493685276;}*/ ?>
<!DOCTYPE html>
...
<form class="form-horizontal col-lg-6 col-lg-offset-4" name="alipayment" id="alipayment" method="post" action="">
    ...
    <input class="form-control" id="return_url" name="return_url" value="http://120.24.79.110/weixin/public/index.php/home/league/notify" type="hidden">
...
<script>
    $(document).ready(function(e) {
        ...
        $(".guding").click(function(){
            switch(paytype){
                case "native":
                    $('#alipayment').attr('action','http://120.24.79.110/weixin/WxpayAPI_php_v3/example/native.php');
                    $('#alipayment').submit();
                    break;
                case "alipay":
