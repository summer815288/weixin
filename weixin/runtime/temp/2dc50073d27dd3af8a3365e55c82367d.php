<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\WWW\weixinss\weixin\public/../application/home\view\index\detail.html";i:1492680202;s:72:"D:\WWW\weixinss\weixin\public/../application/home\view\index\footer.html";i:1492665450;}*/ ?>
...
<head>
    ...
    <style>
        *{
        ...
        .article{
            font-size: 40px;color:grey;line-height:25px;text-indent:2em;
        }
...
<center>
    <?php if(($arr['uid'] =='')): ?>
    <div style="position:absolute;top:0px;left:0px;width:100%;height:550px;z-index:1;background: black;"  id="tans">
    ...
    <video src="../../../../public/video/<?php echo $arr['video']; ?>" controls   style="width:100%;height:auto" id="myVideo" ></video>
    <?php else: ?>
    <video src="../../../../public/video/<?php echo $arr['video']; ?>" controls   style="width:100%;height:auto"  ></video>
    <?php endif; ?>
    ...
    <div class="choo">
        ...
        <ul class="rightawei" hidden>
            ...
            <?php foreach ($arrComment  as $kC => $vC): ?>
            <li style="margin-left: 5%"><?= $vC['cid']  ?>&nbsp;&nbsp;<?= $vC['addTime']  ?></li>
            <li style="margin-left: 4%;word-wrap:break-word;">&nbsp;<?= $vC['comment']  ?></li>
            <li style="margin-left:70%;">
                <span class="backCom" cid="<?=$vC['cid'] ?>"  uname="<?= $vC['uid'] ?>" uid="<?= $vC['uid'] ?>" path="<?=$vC['path'] ?>">回复</span>|
