<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"/data/wwwroot/default/weixin/public/../application/home/view/index/video.html";i:1493198627;s:79:"/data/wwwroot/default/weixin/public/../application/home/view/index/footer2.html";i:1492765101;}*/ ?>
<?php
use think\Url;
?>
<html lang="en">
                ...
                <table style="padding: 20px;font-size: 50px;">
                    <tr>
                        <td>
                            ...
                            <img src="../../../../public/uploads/zhibo/<?php echo $v['video_img']; ?>" width="700" height="400">
                                <p style="font-size: 30px;text-align: center;"><?php echo $v['video_name']; ?></p>
                            </a>
                        </td>

                    </tr>
                    <tr>
                        <td><p style="font-size: 30px"><?php echo date('Y-m-d H:i:s开始',$v['video_start']); ?>&nbsp;|&nbsp;<?php echo date('Y-m-d H:i:s结束',$v['video_end']); ?></p></td>
                    </tr>
                </table>
            <?php endforeach; ?>
        </div>
