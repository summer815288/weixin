<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\phpStudy\WWW\weixin\weixin\public/../application/admin\view\index\index.html";i:1492673487;}*/ ?>
 <!DOCTYPE html>
    <html>
    <head>
        <meta charset="utf-8" />
        ...
        <div class="public-ifame-leftnav">
            ...
            <ul class="left-nav-list">
                ...
                <li class="public-ifame-item">
                    ...
                    <div class="ifame-item-sub">
                        <ul>
                            <li><a href="<?php echo url('video/video_list'); ?>"  target="content">展示直播</a>&nbsp;|&nbsp;<a href="<?php echo url('video/index'); ?>" target="content">添加</a></li>
