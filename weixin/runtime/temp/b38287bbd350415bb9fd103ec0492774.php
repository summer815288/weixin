<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"H:\web\wifi\php_11\weixing\weixin\public/../application/home\view\index\index.html";i:1493785476;s:83:"H:\web\wifi\php_11\weixing\weixin\public/../application/home\view\index\footer.html";i:1493785476;}*/ ?>
<!doctype html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<center>
    ...
    <!--轮播图-->
    <div class="type">
        <?php if(is_array($data['type']) || $data['type'] instanceof \think\Collection || $data['type'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data['type'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vv): $mod = ($i % 2 );++$i;?>
        <a href="__URL__/majors?tid=<?php echo $vv['tid']; ?>"><button style="color:<?php echo $vv['color']; ?>"><?php echo $vv['tname']; ?></button></a>
        <?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
