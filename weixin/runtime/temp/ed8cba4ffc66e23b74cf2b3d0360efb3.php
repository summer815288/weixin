<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"/data/wwwroot/default/weixin/public/../application/admin/view/index/index.html";i:1493697864;}*/ ?>
 <!DOCTYPE html>
    <html>
    <head>
        <meta charset="utf-8" />
    ...
    <div class="public-header">
        <div class="content">
            ...
            <div class="public-header-admin fr">
                <p class="admin-name"><?php if(($uname == '')): ?> 请先登录<?php else: ?><font color="red"><?php echo $uname; ?></font>管理员 您好！<?php endif; ?></p>
                <div class="public-header-fun fr">
                    <a href="" class="public-header-man">管理</a>
                    <a href="__URL__/login_out" class="public-header-loginout">安全退出</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="public-ifame-leftnav">
            ...
            <ul class="left-nav-list">
                ...
                <li class="public-ifame-item">
                    ...
                    <div class="ifame-item-sub">
                        <ul>
                            <li><a href="<?php echo url('apply/index'); ?>" target="content">数据库导出</a></li>
                            <li><a href="<?php echo url('apply/apply_list'); ?>" target="content">数据库导入</a></li>
                        </ul>
                    </div>
                </li>
            </ul>
