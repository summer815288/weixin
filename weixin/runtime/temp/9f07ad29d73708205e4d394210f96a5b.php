<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/data/wwwroot/default/weixin/public/../application/home/view/center/course.html";i:1493207739;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
    <meta charset="utf-8">
...
<ul class="fav_list" style="height:200px;">
    ...
    <?php if($val['state'] == 1): ?>
        <a href="#">
            ...
            <i class="pic"><video src="../../../../public/video/<?php echo $val['video']; ?>" style="height: 100%;width: 100%"  controls="controls">
            </video></i>
