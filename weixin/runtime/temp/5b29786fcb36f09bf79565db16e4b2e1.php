<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/data/wwwroot/default/weixin/public/../application/admin/view/category/show.html";i:1492678056;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <button type="button" class="button border-yellow" onclick="window.location.href='__URL__/add'"><span class="icon-plus-square-o"></span> 添加内容</button>
    </div>
